...
@interface PagerDataViewController : GAITrackedViewController<GPPSignInDelegate,UIWebViewDelegate,UIScrollViewAccessibilityDelegate,UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,AAShareBubblesDelegate>
...
@property(strong,nonatomic)IBOutlet UITableViewCell *cell_action;
